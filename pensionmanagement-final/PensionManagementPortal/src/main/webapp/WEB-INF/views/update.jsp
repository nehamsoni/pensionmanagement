				...
				<div class="card-wrapper">
					...
					<div class="card fat">
						<div class="card-body">
							...
							<sf:form action="/updatepensiondetails" modelAttribute="pensiondetails" method="post" name="form">
				 ...
				 <sf:errors style="color:red" path="dateOfBirth"></sf:errors>
						...
						name="aadharNumber" /> <sf:errors style="color:red" path="aadharNumber"></sf:errors>
								...
								<div class="form-group">
									...
									<sf:input path="salary" id="salary"
						name="salary" /> <sf:errors style="color:red" path="salary"></sf:errors>
								...
								<div class="form-group">
									...
									<sf:input path="allowances" id="allowances"
						name="allowances" /> <sf:errors style="color:red" path="allowances"></sf:errors>
									...
									<sf:input path="accountNumber" id="accountNumber"
						name="accountNumber" /> <sf:errors style="color:red" path="accountNumber"></sf:errors>
								...
								<div class="form-group">
                                    <label for="selfOrFamilyPension">Pension Type</label>
                                    <select  class="form-control"  name="selfOrFamilyPension" id="selfOrFamilyPension">
